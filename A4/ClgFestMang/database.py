...
def rebuild_db():
    ...
    event = ClgFestMang.models.Event(EName='Dance', Date='2024-01-01', Desc='Dance with Aviral', Winner1='Aviral', Winner2='Aviral', Winner3='Aviral', Venue='Kalidas', Sponsor='Pepsi')
    db_session.add(event)
    event = ClgFestMang.models.Event(EName='Music', Date='2024-03-06', Desc='Music with Aviral', Winner1='Aviral', Winner2='Aviral', Winner3='Aviral',Venue='Kalidas', Sponsor='Pepsi')
    db_session.add(event)
    ...
    food = ClgFestMang.models.food(Name = 'Chicken', type = True, detail = 'Chicken')
    db_session.add(food)
    food = ClgFestMang.models.food(Name = 'Paneer', type = False, detail = 'Paneer')
    db_session.add(food)
