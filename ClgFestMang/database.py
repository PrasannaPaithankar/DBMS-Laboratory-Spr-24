...
def rebuild_db():
    ...
    stu = ClgFestMang.models.Student(Name='test', email='t@t', password=generate_password_hash('t'), Dept='CSE', RID=1, gender=True)
    db_session.add(stu)
    stu = ClgFestMang.models.Student(Name='prasanna', email='p@p', password=generate_password_hash('p'), Dept='CSE', RID=2, gender=True)
    db_session.add(stu)
